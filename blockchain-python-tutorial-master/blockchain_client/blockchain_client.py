...
class Transaction:
    ...
    def __init__(self, sender_address, sender_private_key, recipient_address, sender_pancard, value):
        self.sender_address = sender_address        
        self.sender_private_key = sender_private_key
        self.recipient_address = recipient_address
        self.sender_pancard = sender_pancard
        self.value = value
    ...
    def to_dict(self):
        return OrderedDict({'sender_address': self.sender_address,
                            ...
                            'sender_pancard': self.sender_pancard,
...
def generate_transaction():
    ...
    sender_pancard = request.form['sender_pancard']
    value = request.form['amount']
    
    transaction = Transaction(sender_address, sender_private_key, recipient_address, sender_pancard,value)
